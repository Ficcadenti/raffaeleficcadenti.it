...
<hmtl>
	<head>
		<title>sorgente: esempio_47.html</title>
		<!-- Sezione per i CSS -->
		<!-- load default.css -->
		<?php
	...
	<body>
		<?php
			...
			paragrafo("Richiama uno script perl.",$num_capitolo);
			$command="env.pl";

			print("<div id=\"m70\"><pre>");
			println("Script da eseguire: '$command'");
		...
		<a href="http://php.net/manual/en/function.system.php" target="_blank">PHP system()</a><br>
